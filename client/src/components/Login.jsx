...
const Login = ({ setShowLogin }) => {
    ...
    return (
        <div
            className="fixed top-0 bottom-0 left-0 right-0 z-[100] flex items-center text-sm bg-black/50 text-gray-600"
        ...
        >
            ...
            >
                ...
                <button
                    type="button"
                    onClick={() => setShowLogin(false)}
                    className="absolute top-3 right-4 text-gray-400 hover:text-gray-700 text-xl cursor-pointer"
                >
                    ×
                </button>
