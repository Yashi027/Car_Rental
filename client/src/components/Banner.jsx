...
const Banner = () => {
  return (
    <div className='flex flex-col md:flex-row md:items-start items-center justify-between px-8 pt-10 min-md:pl-14 bg-gradient-to-r from-[#0558FE] to-[#A9CFFF] mx-3 max-w-6xl md:mx-auto rounded-2xl overflow-hidden'>
