...
const MyBookings = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24 2xl:px-32 pt-8 sm:pt-12 pb-16 sm:pb-20">
        ...
        <div className="mt-5 space-y-6">
          ...
          {bookings.length > 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-12">
                  ...
                  <div className="md:col-span-8 lg:col-span-5 p-5 sm:p-6 lg:p-8">
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      ...
                      <span
                        className={`px-3 py-1.5 text-xs font-semibold rounded-full capitalize shrink-0 ${
                    ...
                    {/* Total Amount - Visible on Mobile */}
            ...
            <div className="bg-white border border-gray-200 rounded-2xl py-16 px-5 text-center">
              ...
              <button className="mt-6 px-6 py-2.5 bg-primary text-white rounded-lg text-sm font-medium hover:opacity-90 transition">
                Browse Cars
              </button>
